...
def main():
    ...
    parser.add_argument('--algo', type=str, choices=['JL_sketch','priority_sampling','threshold_sampling','CS_sketch','base_line','KMV_sketch','MH_sketch'], required=True, action='append', help="what algorithm(s) to use")
    ...
    for algo in args.algo:
        if algo == 'tensor_sketch':
            ...
            algorithms.append(base_line(args.sketch_size))
        elif algo == 'KMV_sketch':
            algorithms.append(KMV_sketch(sketch_size=args.sketch_size))
        elif algo == 'MH_sketch':
            algorithms.append(MH_sketch(sketch_size=args.sketch_size))
